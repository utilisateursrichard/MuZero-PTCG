...
def generate_deck_svg(cards_info: list[dict], out_path: Path) -> None:
    ...
    <defs>
        <style>
            ...
            .badge-bg { fill: #38bdf8; rx: 12px; ry: 12px; }
    ...
    logger.info("Deck exporté avec succès dans %s", out_path)


def main():
    parser = argparse.ArgumentParser(description="Génère deck.svg depuis deckbuilder.safetensors")
    parser.add_argument("--safetensors", "--ckpt", default=None, help="Chemin du fichier .safetensors")
    parser.add_argument("--out", default="deck.svg", help="Fichier SVG de sortie")
